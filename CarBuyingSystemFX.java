...
public class CarBuyingSystemFX extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        welcomeLayout.setStyle("-fx-padding: 20; -fx-background-color: #ADD8E6;"); // Light blue background
        welcomeLayout.setAlignment(Pos.CENTER); // Center the content
    ...
    private void showAvailableCars() {
        // Create UI components for the car selection page
        TextArea carListArea = new TextArea();
        carListArea.setEditable(false);
        carListArea.setText(showroom.getAvailableCars());
        carListArea.setStyle("-fx-background-color: #90EE90; -fx-text-fill: #000000; -fx-border-color: #cccccc; -fx-border-radius: 5;"); // Light green background

        // ComboBox for car selection
        ComboBox<String> carModelComboBox = new ComboBox<>();
        carModelComboBox.getItems().addAll(showroom.getCarModels()); // Add car models to ComboBox
        ...
        carSelectionLayout.setStyle("-fx-padding: 20; -fx-background-color: #ADD8E6;"); // Light blue background
        carSelectionLayout.setAlignment(Pos.CENTER); // Center the content
    ...
    private void handlePayment(String paymentMethod, ComboBox<String> carModelComboBox) {
        String carModel = carModelComboBox.getValue(); // Get selected car model
    ...
    private void showCustomerDetails(String confirmationMessage, String paymentDetails, Car purchasedCar) {
        // Create UI components for the customer details page
        ...
        confirmButton.setOnAction(e -> {
            ...
            // Here you can process the customer details as needed
        ...
        customerDetailsLayout.setAlignment(Pos.CENTER); // Center the content
    ...
    private void showOutputResult(String confirmationMessage, String paymentDetails, Car purchasedCar, String customerName, String email, String nid, String phoneNumber) {
        // Create UI components for the output result page
        ...
        backButton.setOnAction(e -> showAvailableCars()); // Go back to car selection page
        ...
        outputLayout.setAlignment(Pos.CENTER); // Center the content
